param
(
    [Parameter(HelpMessage = 'Hapus Podcast dari Homepage?.')]
    [switch]$podcasts_off,
    
    [Parameter(HelpMessage = 'Jangan Hapus Podcast dari Home.')]
    [switch]$podcasts_on,
    
    [Parameter(HelpMessage = 'Matikan otomatis Update.')]
